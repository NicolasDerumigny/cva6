...
module fpu_multicore_wrap
  import ariane_pkg::*;
#(
    parameter config_pkg::cva6_cfg_t CVA6Cfg = config_pkg::cva6_cfg_empty,
    parameter type exception_t = logic,
    parameter type fu_data_sf_t = logic
) (
    input  logic        clk_i,
    input  logic        rst_ni,
    input  logic        flush_i,
    ...
    input  fu_data_sf_t fu_data_i,

    input  logic       [                    1:0] fpu_fmt_i,
    input  logic       [                    2:0] fpu_rm_i,
    input  logic       [                    2:0] fpu_frm_i,
    input  logic       [                    6:0] fpu_prec_i,
    output logic       [CVA6Cfg.TRANS_ID_BITS:0] fpu_trans_id_o,
  ...
  if (CVA6Cfg.FpPresent) begin : fpu_gen
    ...
    fpnew_top #(
        ...
        .TagType       (logic [CVA6Cfg.TRANS_ID_BITS:0])
    ) i_fpnew_bulk (
        .clk_i,
        .rst_ni,

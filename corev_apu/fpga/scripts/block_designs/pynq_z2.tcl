...
proc create_hier_cell_northbridge { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst periphs_aresetn
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins cpu_aresetn] [get_bd_pins axi_riscv_atomics_wrapper_0/aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN]
  connect_bd_net -net aclk1_1 [get_bd_pins clk_cpu] [get_bd_pins axi_riscv_atomics_wrapper_0/CLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK]
  ...
  connect_bd_net -net periphs_aresetn_1 [get_bd_pins periphs_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN]
  connect_bd_net -net periphs_clk_1 [get_bd_pins periphs_clk] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK]
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.CLK_OUT3_PORT {clk_periphs} \
  ...
  # Create instance: periphs_sys_reset_0, and set properties
  set periphs_sys_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 periphs_sys_reset_0 ]
  ...
  connect_bd_net -net atop_tieoff_0_dout [get_bd_pins atop_tieoff_0/dout] [get_bd_pins ariane_peripherals_0/s_axi_plic_awatop] [get_bd_pins ariane_peripherals_0/s_axi_timer_awatop] [get_bd_pins ram_offset_to_zero_0/s_axi_ram_awatop] [get_bd_pins debug_module_wrapper_0/s_axi_dmi_jtag_awatop] [get_bd_pins clint_0/s_axi_clint_awatop]
  ...
  connect_bd_net -net clk_cpu_1 [get_bd_pins clk_wiz_0/clk_core] [get_bd_pins northbridge/clk_cpu] [get_bd_pins cpu_0/aclk] [get_bd_pins debug_module_wrapper_0/aclk] [get_bd_pins cpu_reset_gen_core/slowest_sync_clk] [get_bd_pins axi_jtag_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins ariane_peripherals_0/aclk] [get_bd_pins axi_bootrom_control/s_axi_aclk] [get_bd_pins clint_0/aclk]
  connect_bd_net -net clk_wiz_0_clk_periphs [get_bd_pins clk_wiz_0/clk_periphs] [get_bd_pins periphs_sys_reset_0/slowest_sync_clk] [get_bd_pins northbridge/periphs_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins ram_offset_to_zero_0/aclk] [get_bd_pins sdcard_quad_spi_axi/s_axi4_aclk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  ...
  connect_bd_net -net ddr_aresetn_1 [get_bd_pins cpu_reset_gen_core/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_bootrom_control/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins ariane_peripherals_0/aresetn] [get_bd_pins clint_0/aresetn]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins periphs_sys_reset_0/interconnect_aresetn] [get_bd_pins northbridge/periphs_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins sdcard_quad_spi_axi/s_axi4_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins cpu_reset_gen_core/ext_reset_in] [get_bd_pins periphs_sys_reset_0/ext_reset_in]
  ...
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins util_vector_logic_2/Res] [get_bd_pins cpu_reset_gen_core/aux_reset_in] [get_bd_pins periphs_sys_reset_0/aux_reset_in]

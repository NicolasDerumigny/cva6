...
# module references:
# bootrom_wrapper, ariane_peripherals_wrapper_verilog, cva6_wrapper_verilog, clint_wrapper_verilog, ram_offset_to_zero, axi_riscv_atomics_wrapper_verilog
...
proc create_hier_cell_northbridge { parentCell nameHier } {
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins cpu_aresetn] [get_bd_pins axi_riscv_atomics_wrapper_0/aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN]
  connect_bd_net -net aclk1_1 [get_bd_pins clk_cpu] [get_bd_pins axi_riscv_atomics_wrapper_0/CLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK]
...
\
  ...
  connect_bd_net -net atop_tieoff_0_dout [get_bd_pins atop_tieoff_0/dout] [get_bd_pins ariane_peripherals_0/s_axi_plic_awatop] [get_bd_pins ariane_peripherals_0/s_axi_timer_awatop] [get_bd_pins ram_offset_to_zero_0/s_axi_ram_awatop] [get_bd_pins clint_0/s_axi_clint_awatop]
  ...
  connect_bd_net -net clk_cpu_1 [get_bd_pins clk_wiz_0/clk_core] [get_bd_pins northbridge/clk_cpu] [get_bd_pins cpu_0/aclk] [get_bd_pins cpu_reset_gen_core/slowest_sync_clk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins ariane_peripherals_0/aclk] [get_bd_pins axi_bootrom_control/s_axi_aclk] [get_bd_pins clint_0/aclk]
  ...
  connect_bd_net -net cpu_interconnect_aresetn_1 [get_bd_pins cpu_reset_gen_core/interconnect_aresetn] [get_bd_pins cpu_0/aresetn] [get_bd_pins northbridge/cpu_aresetn]
  connect_bd_net -net ddr_aresetn_1 [get_bd_pins cpu_reset_gen_core/peripheral_aresetn] [get_bd_pins axi_bootrom_control/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins ariane_peripherals_0/aresetn] [get_bd_pins clint_0/aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins axi_uart16550_0/freeze] [get_bd_pins ariane_peripherals_0/eth_irq_i] [get_bd_pins cpu_0/debug_req_irq]

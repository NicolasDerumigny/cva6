...
proc create_hier_cell_northbridge { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn3] [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins axidebug_0/SLOT_0_AXI]
  ...
  connect_bd_net -net S02_ARESETN_1 [get_bd_pins cpu_peripheral_aresetn] [get_bd_pins axidebug_0/probe4] [get_bd_pins axidebug_0/resetn]
  connect_bd_net -net S02_ARESETN_2 [get_bd_pins aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axidebug_0/probe3] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/M08_ARESETN] [get_bd_pins axi_riscv_atomics_wrapper_0/aresetn]
  connect_bd_net -net aclk1_1 [get_bd_pins clk_cpu] [get_bd_pins axidebug_0/clk] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_riscv_atomics_wrapper_0/CLK]
  connect_bd_net -net axi_riscv_atomics_wrapper_0_m_axi_out_awatop [get_bd_pins cpu_atop_in] [get_bd_pins axidebug_0/probe0] [get_bd_pins axidebug_0/probe1] [get_bd_pins axi_riscv_atomics_wrapper_0/s_axi_in_awatop]
...
\
  ...
  connect_bd_net -net axi_uart16550_0_ip2intc_irpt [get_bd_pins axi_uart16550_0/ip2intc_irpt] [get_bd_pins irqconcat/In0]
  ...
  connect_bd_net -net cpu_debug_ndmreset [get_bd_pins cpu_debug/ndmreset] [get_bd_pins northbridge/ndmreset] [get_bd_pins cpu_reset_gen/ext_reset_in] [get_bd_pins irq_ila/probe5]
  ...
  connect_bd_net -net irqconcat_dout [get_bd_pins irqconcat/dout] [get_bd_pins irq_ila/probe4] [get_bd_pins ariane_peripherals_0/irqs_in]
  connect_bd_net -net mig_aclk_1 [get_bd_pins ddr4_0/addn_ui_clkout1] [get_bd_pins northbridge/aclk] [get_bd_pins northbridge/clk_cpu] [get_bd_pins axi_bootrom_control/s_axi_aclk] [get_bd_pins sdcard_quad_spi_axi/ext_spi_clk] [get_bd_pins sdcard_quad_spi_axi/s_axi4_aclk] [get_bd_pins cpu_reset_gen/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins irq_ila/clk] [get_bd_pins axi_jtag_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins clint_0/aclk] [get_bd_pins cpu_0/aclk] [get_bd_pins cpu_debug/aclk] [get_bd_pins ariane_peripherals_0/aclk]
  ...
  connect_bd_net -net sdcard_quad_spi_axi_ip2intc_irpt [get_bd_pins sdcard_quad_spi_axi/ip2intc_irpt] [get_bd_pins irqconcat/In1]

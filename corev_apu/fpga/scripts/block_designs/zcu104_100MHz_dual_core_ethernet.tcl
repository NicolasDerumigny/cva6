...
proc create_root_design { parentCell } {
  ...
  if { [catch {set cpu_debug [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.NR_CORES {2} $cpu_debug
...
connect_bd_intf_net -intf_net [get_bd_intf_nets cpu_0_m_axi_cpu] [get_bd_intf_pins cpu_0/m_axi_cpu] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  # Create port connections
  connect_bd_net -net ariane_peripherals_0_irq_out [get_bd_pins ariane_peripherals_0/irq_out] [get_bd_pins system_ila_0/probe1] [get_bd_pins cpu_0/irqs_in]
  connect_bd_net -net atop_tieoff_0_dout [get_bd_pins atop_tieoff_0/dout] [get_bd_pins ariane_peripherals_0/s_axi_plic_awatop] [get_bd_pins ariane_peripherals_0/s_axi_timer_awatop] [get_bd_pins clint_0/s_axi_clint_awatop] [get_bd_pins cpu_debug/s_axi_dmi_jtag_awatop]
  ...
  connect_bd_net -net clint_0_ipi_o [get_bd_pins clint_0/ipi_o] [get_bd_pins system_ila_0/probe0] [get_bd_pins cpu_0/ipi_in]
  connect_bd_net -net clint_0_timer_irq_o [get_bd_pins clint_0/timer_irq_o] [get_bd_pins cpu_0/timer_irq_i]
  connect_bd_net -net cpu_0_instr0 [get_bd_pins cpu_0/instr0] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net cpu_0_instr1 [get_bd_pins cpu_0/instr1] [get_bd_pins system_ila_0/probe5]
  ...
  connect_bd_net -net mig_aclk_1 [get_bd_pins ddr4_0/addn_ui_clkout2] [get_bd_pins northbridge/aclk] [get_bd_pins northbridge/clk_cpu] [get_bd_pins axi_bootrom_control/s_axi_aclk] [get_bd_pins sdcard_quad_spi_axi/s_axi4_aclk] [get_bd_pins cpu_reset_gen/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins axi_jtag_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins axi_eth_led_gpio/s_axi_aclk] [get_bd_pins ariane_peripherals_0/aclk] [get_bd_pins clint_0/aclk] [get_bd_pins cpu_debug/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins cpu_0/aclk]

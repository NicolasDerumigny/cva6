...
# module references:
# bootrom_wrapper, ariane_peripherals_wrapper_verilog, cva6_wrapper_verilog, clint_wrapper_verilog, debug_module_wrapper_verilog, axi_riscv_atomics_wrapper_verilog, axi_xbar_interface_verilog
...
proc create_hier_cell_Ethernet_Subsystem { parentCell nameHier } {
  ...
  connect_bd_net -net Net [get_bd_pins axi_clk] [get_bd_pins axi_eth_dma/s_axi_lite_aclk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_eth_dma/m_axi_sg_aclk] [get_bd_pins axi_eth_dma/m_axi_mm2s_aclk] [get_bd_pins axi_eth_dma/m_axi_s2mm_aclk] [get_bd_pins eth_clk/clk_in1] [get_bd_pins eth_dma_axi_protocol_convert/aclk] [get_bd_pins eth_s_axi_protocol_convert1/aclk] [get_bd_pins eth_dma_axi_dwidth_converter/s_axi_aclk] [get_bd_pins axi_dwidth_converter_0/s_axi_aclk] [get_bd_pins axi_dwidth_converter_1/s_axi_aclk]
...
proc create_hier_cell_northbridge { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_riscv_atomics_wrapper_0_m_axi_out [get_bd_intf_pins axi_riscv_atomics_wrapper_0/m_axi_out] [get_bd_intf_pins axi_clock_converter_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_xbar_interface_v_0_m_axi_ram [get_bd_intf_pins axi_xbar_interface_v_0/m_axi_ram] [get_bd_intf_pins axi_riscv_atomics_wrapper_0/s_axi_in]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets cpu_0_m_axi_cpu] [get_bd_intf_pins cpu_0/m_axi_cpu] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net clint_0_timer_irq_o [get_bd_pins clint_0/timer_irq_o] [get_bd_pins system_ila_0/probe7] [get_bd_pins cpu_0/timer_irq_i]
  connect_bd_net -net cpu_0_flush1 [get_bd_pins cpu_0/flush1] [get_bd_pins system_ila_0/probe15]
  ...
  connect_bd_net -net cpu_0_lsu_ctrl_be1 [get_bd_pins cpu_0/lsu_ctrl_be1] [get_bd_pins system_ila_0/probe10]
  connect_bd_net -net cpu_0_lsu_ctrl_fu1 [get_bd_pins cpu_0/lsu_ctrl_fu1] [get_bd_pins system_ila_0/probe11]
  connect_bd_net -net cpu_0_lsu_ctrl_trans_id1 [get_bd_pins cpu_0/lsu_ctrl_trans_id1] [get_bd_pins system_ila_0/probe12]
  connect_bd_net -net cpu_0_lsu_ctrl_vaddr1 [get_bd_pins cpu_0/lsu_ctrl_vaddr1] [get_bd_pins system_ila_0/probe13]
  connect_bd_net -net cpu_0_m_axi_cpu_awatop [get_bd_pins cpu_0/m_axi_cpu_awatop] [get_bd_pins northbridge/cpu_atop_in]
  connect_bd_net -net cpu_0_mcause1 [get_bd_pins cpu_0/mcause1] [get_bd_pins system_ila_0/probe16]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000000000000000 -target_address_space [get_bd_addr_spaces northbridge/axi_xbar_interface_v_0/m_axi_ram] [get_bd_addr_segs northbridge/axi_riscv_atomics_wrapper_0/s_axi_in/reg0] -force
